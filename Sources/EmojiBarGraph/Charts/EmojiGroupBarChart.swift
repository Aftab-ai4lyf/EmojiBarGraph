...
////        yValues: .constant([
////            [
////                .init(progress: 0, totalProgress: 0, color: "#FA6418", emoji: "", title: ""),
////                .init(progress: 0, totalProgress: 1512, color: "#BD013C", emoji: "", title: "")
////            ],
////            [
////                .init(progress: 0, totalProgress: 0, color: "#FA6418", emoji: "", title: ""),
////                .init(progress: 0, totalProgress: 0, color: "#BD013C", emoji: "", title: "")
////            ],
////            [
////                .init(progress: 0, totalProgress: 0, color: "#FA6418", emoji: "", title: ""),
////                .init(progress: 0, totalProgress: 0, color: "#BD013C", emoji: "", title: "")
...
////        showEmoji: false , showYValues: false, showLines: false
////    )
////    .setYAxisTitle("Number of Puffs")
////    .setValuesColor(.black)
////}
//
//
//@available(iOS 17.0, *)
...
public struct EmojiGroupBarChart: View {
    ...
    private func areaMarkView() -> some View {
        ...
        if showAreaMark {
            ...
            .chartYAxis(.hidden)
            .background(.clear)
            .padding(.leading, showYValues ? 36 : 0)
        }
    }
